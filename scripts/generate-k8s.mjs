...
function configMap(platform, config) {
  ...
  return {
    ...
    data: {
      ...
      MODEL_ROUTER_PROVIDERS_JSON: String(llm.providersJson || "[]"),
...
function modelRouterEnv(llm = {}) {
  const env = [
    ...
    envValue("MODEL_ROUTER_DEFAULT_PROVIDER", llm.defaultProvider || "local"),
    ...
    envValue("MODEL_ROUTER_PROVIDERS_JSON", llm.providersJson || "[]"),
